...
const Icon = ({ name, size = 20, stroke = 1.6 }) => {
  ...
  switch (name) {
    ...
    case "logo":
      return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round"><path d="M3 18 12 4l9 14"/><path d="M7 18 12 10l5 8"/></svg>;
    case "menu":
