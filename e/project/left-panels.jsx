// Left column: profile, to-do, messages, history
    ...
    <section className="panel profile">
      <div className="profile-top">
        <div className="avatar-wrap">
          ...
          <span className="avatar-status" title="在線中"></span>
        </div>
...
const MessageCenter = () => {
  const { MESSAGES } = window.E_DATA;
  const Icon = window.Icon;
  return (
    <section className="panel msg">
      <div className="panel-head">
        <h3><span className="bar"></span>訊息中心</h3>
...
const HistoryPanel = () => {
  const { HISTORY } = window.E_DATA;
  return (
    <section className="panel history">
      <div className="panel-head">
        <h3><span className="bar"></span>學習軌跡</h3>
      </div>
      <ol className="hist-list">
        {HISTORY.map((h, i) => (
          <li key={i} className="hist-item">
            <span className="hist-node"><span></span></span>
            <div>
...
window.LeftPanels = { ProfilePanel, TodoCard, MessageCenter, HistoryPanel };
