...
const Cover = ({ theme }) => {
  ...
  return (
    <svg className="cover-svg" viewBox="0 0 400 220" preserveAspectRatio="xMidYMid slice">
      ...
      <text x="32" y="180" fontFamily="ui-monospace, SFMono-Regular, Menlo, monospace" fontSize="13" letterSpacing="2" fill={t.accent} opacity="0.85">
        {t.label.toUpperCase()}
      </text>
      <text x="32" y="200" fontFamily="ui-monospace, SFMono-Regular, Menlo, monospace" fontSize="9" letterSpacing="1.5" fill="#ffffff" opacity="0.4">
        JOHNSON · e-ACADEMY
      </text>
